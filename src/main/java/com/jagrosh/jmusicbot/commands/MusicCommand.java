...
public abstract class MusicCommand extends Command 
{
    ...
    protected void execute(CommandEvent event) 
    {
        ...
        if(beListening)
        {
            AudioChannelUnion currentUnion = event.getGuild().getSelfMember().getVoiceState().getChannel();
            VoiceChannel current = currentUnion instanceof VoiceChannel ? (VoiceChannel) currentUnion : null;
            if (current == null)
