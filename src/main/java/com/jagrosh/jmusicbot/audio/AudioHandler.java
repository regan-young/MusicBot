...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler {
	...
	private final StreamingPlayerManager smanager;
	private final AudioPlayer audioPlayer;
	private final long guildId;

	private AudioFrame lastFrame;

	protected AudioHandler(PlayerManager manager, StreamingPlayerManager smanager, Guild guild, AudioPlayer player) {
	...
	public Message getNowPlaying(JDA jda) {
		if (isMusicPlaying(jda)) {
			...
			eb.setDescription(getStatusEmoji() + " " + FormatUtil.progressBar(progress) + " `["
	...
	public Message getNoMusicPlaying(JDA jda) {
		...
		return new MessageBuilder()
				...
				.setEmbeds(new EmbedBuilder().setTitle("No music playing")
	...
	/*
	 * @Override public boolean canProvide() { if (lastFrame == null) lastFrame =
	 * audioPlayer.provide();
	 * 
	 * return lastFrame != null; }
	 * 
	 * @Override public byte[] provide20MsAudio() { if (lastFrame == null) lastFrame
	 * = audioPlayer.provide();
	 * 
	 * byte[] data = lastFrame != null ? lastFrame.getData() : null; lastFrame =
	 * null;
	 * 
	 * return data; }
	 */
