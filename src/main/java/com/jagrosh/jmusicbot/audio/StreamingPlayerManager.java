...
public class StreamingPlayerManager extends DefaultAudioPlayerManager 
{
	private static final Logger log = LoggerFactory.getLogger(StreamingPlayerManager.class);
	...
	private final FMSourceManager fm;

	public StreamingPlayerManager(Bot bot, FMSourceManager fm) {
		this.streams = new HashMap<>();
		this.resolutionCache = new ResolutionCache(1000);
		this.streamFrameCount = 4;
		this.bot = bot;
		this.fm = fm;
	}
    ...
    public AudioHandler setUpHandler(Guild guild)
    {
        ...
        if(guild.getAudioManager().getSendingHandler() == null)
        {
            ...
            handler = new AudioHandler(null, this, guild, player);
